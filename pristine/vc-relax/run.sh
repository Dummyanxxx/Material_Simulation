#!/bin/bash
#SBATCH --job-name=vc-relax 	             # Job name (sesuaikan sesuai kebutuhan)
...
#SBATCH --output=vc-relax.log                # Log output dan error (berdasarkan Job ID)
...
mpirun -np $SLURM_NTASKS pw.x < /mgpfs/home/yfadhilah/bulk/b1/vc-relax/vc-relax.in > /mgpfs/home/yfadhilah/bulk/b1/vc-relax/vc-relax.out
